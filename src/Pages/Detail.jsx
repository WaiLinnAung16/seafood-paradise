...
const Detail = () => {
  ...
  return (
    <div className=" min-h-screen flex justify-center items-center py-20 mb-[230px]">
      <div>
        ...
        <h1 className="font-bold text-slate-100 text-2xl md:text-3xl uppercase text-center mb-10">
          {detail?.strMeal}
        </h1>
        <div className=" container mx-auto flex flex-col lg:flex-row justify-center items-center gap-10">
          <img
            ...
            alt=""
            className=" w-[90%] lg:mx-0 lg:w-[400px] rounded-md"
          />
