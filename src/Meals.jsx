    ...
    <div className="">
      <div className="container mx-auto py-10">
        <div className=" flex justify-between items-center gap-3">
          <h1 className=" text-secondary font-bold text-3xl uppercase border-b-2 border-primary">
            Discover Recipes
          </h1>
          <div className=" relative w-96 group/item">
            ...
            />
            <BiSearchAlt className="text-2xl text-white bg-primary h-10 w-10 p-2 cursor-pointer rounded-r-lg absolute bottom-0 right-0" />
          </div>
        </div>
